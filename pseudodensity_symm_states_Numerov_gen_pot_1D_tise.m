## pseudodensity_symm_states_Numerov_gen_pot_1D_tise.m
##
...
if (idensity_save == 1)
  ...
  savemat_rho = [k_values; E_values]; # pseudodensity matrix <\psi_j|\phi_k>_g + <\psi_j|\phi_k>_u 
  ##
  savemat_rho2 = [k_values; E_values]; #  |<\psi_j|\phi_k>_g + <\psi_j|\phi_k>_u|^2 
  ##
  savemat_tot_rho = [k_values; E_values]; # \sum_j |<\psi_j|\phi_k>_g + <\psi_j|\phi_k>_u|^2 
  ##
endif
####################################################################
####################################################################
