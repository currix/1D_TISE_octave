## w_Numerov_lr.m
##
## Central difference reconstructed wf and first derivative at the matching point for
...
## by Currix TM
##
function [wfl, wfr, wpfl, wpfr] = w_Numerov_lr(e0)
  ##
  global xgrid;
  global x_step;
  global match_p;
  ...
  if (mod(nodes_num,2) == 0) 
    y_right(npoints) = norm_val; ## even case
  else
    y_right(npoints) = -abs(norm_val); ## odd case
  endif
  ##
